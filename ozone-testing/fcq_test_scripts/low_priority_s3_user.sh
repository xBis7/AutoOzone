...
if [[ $bucket_res == *"BUCKET_NOT_FOUND"* ]]; then
...
doAnsibleWithNodeNameAsOzUser "$node_name" "$oz_user" shell "/hadoop/app/ozone/bin/ozone freon s3kg -e http://$S3G1_HOSTNAME:9878 -t 100 -n 1000000 -b bucket1 -p s3low"
